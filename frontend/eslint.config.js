...
export default [
  ...
  js.configs.recommended, // Habilita as regras recomendadas do TypeScript
  {
    files: ["**/*.{ts,tsx}"],
    languageOptions: {
      parser: tsParser,
  ...
  {
    files: ["**/*.{js,jsx,ts,tsx}"],
    ...reactPlugin.configs.flat.recommended, // Adiciona o suporte para o novo JSX transform
    ...reactPlugin.configs.flat["jsx-runtime"], // Configurações compartilhadas
    settings: {
      react: {
